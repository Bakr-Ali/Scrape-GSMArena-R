...
xml2::write_xml(read_html(url), file = "read_html_0.html")
xml2::write_xml(xml2::read_html(url), file = "read_html_xml2.html")
xml2::write_xml(rvest::read_html(url), file = "read_html_rvest.html")
